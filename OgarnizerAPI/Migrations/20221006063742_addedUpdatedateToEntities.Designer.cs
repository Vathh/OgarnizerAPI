...
namespace OgarnizerAPI.Migrations
{
    ...
    [Migration("20221006063742_addedUpdatedateToEntities")]
    partial class addedUpdatedateToEntities
    {
            ...
            modelBuilder.Entity("OgarnizerAPI.Entities.ClosedOrder", b =>
                {
                    ...
                    b.Property<int?>("FK_ClosedOrders_Users_CloseUserId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FK_ClosedOrders_Users_CloseUserId");
            ...
            modelBuilder.Entity("OgarnizerAPI.Entities.ClosedService", b =>
                {
                    ...
                    b.Property<int?>("FK_ClosedServices_Users_CloseUserId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FK_ClosedServices_Users_CloseUserId");
            ...
            modelBuilder.Entity("OgarnizerAPI.Entities.ClosedOrder", b =>
                {
                    b.HasOne("OgarnizerAPI.Entities.User", "CloseUser")
                        ...
                        .HasForeignKey("FK_ClosedOrders_Users_CloseUserId");
            ...
            modelBuilder.Entity("OgarnizerAPI.Entities.ClosedService", b =>
                {
                    b.HasOne("OgarnizerAPI.Entities.User", "CloseUser")
                        ...
                        .HasForeignKey("FK_ClosedServices_Users_CloseUserId");
